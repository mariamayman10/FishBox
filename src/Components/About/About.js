...
import AboutC4 from "./AboutComponents/AboutC4";
import AboutC2 from "./AboutComponents/AboutC2";
...
const About = () => {
  return (
    <>
      ...
      <section className="about-section pt-5 m-auto">
        <div className="about-images row d-flex flex-wrap justify-content-center m-auto">
