      ...
      <div className="Home__section3 pb-5">
        ...
        <div className="Home__section3-content row m-auto col-lg-8 col-md-10 col-11 pb-4">
            <div className="Home__section3-col1 col-lg-5 col-md-7 col-8">
              <p className="Home__section3-col1-p1 mb-2 mt-lg-5 mt-md-5 mt-3 ms-lg-5 ms-md-5 ms-2">FISH BOX</p>
              ...
              <button className="Home__section3-col1-btn ms-lg-5 ms-md-5 ms-2 mb-3">LEARN MORE</button>
            </div>
