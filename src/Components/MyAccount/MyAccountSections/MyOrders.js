...
import OrderCard from "../MyAccountComp/OrderCard";
...
const MyOrders = () => {
  const product1 = new InventoryProduct(
    "Salmon",
    "P001",
    15.99,
    100,
  ...
  const product4 = new InventoryProduct(
    "Shrimp",
    "P004",
    18.99,
    60,
  ...
  const product5 = new InventoryProduct(
    "Lobster",
    "P005",
    25.99,
    30,
  ...
  const orders = [
    ...
    new Order(
      ...
      new Date("2024-08-03"),
      "Delivered",
      [orderProduct1, orderProduct3, orderProduct4, orderProduct5, orderProduct2],
